...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Result resultItem = (Result) intent.getSerializableExtra("Result");

        Log.d("WebViewActivity -  로그", ucode);
        //@ 유저 아이디바꿔야됨
        String query = "/"+ucode+"/" +resultItem.deviceID+ "/" +resultItem.inspectionIdx;
...
//        });
        ...
        findViewById(R.id.web_back).setOnClickListener(v -> {
            Log.i("WebViewActivity", "onCreate: WebView go back");
            mwv.goBack();
        });
...
//
//                Intent intent = new Intent(WebViewActivity.this, ErrorHandlingActivity.class);
